...
class Ui_LoginDialog(object):
    ...
    def setupUi(self, LoginDialog):
        ...
        self.page.setTabOrder(self.loginInput, self.passwordInput)
        self.page.setTabOrder(self.passwordInput, self.loginButton)
        self.page.setTabOrder(self.loginButton, self.newUserButton)
        self.page_2 = QtWidgets.QWidget()
        self.page_2.setObjectName("page_2")
        self.req = QtWidgets.QLabel(self.page_2)
        self.req.setGeometry(QtCore.QRect(160, 0, 251, 31))
        self.req.setText("Login/password 5 to 16 characters(a-zA-Z0-9)")
        self.req.setObjectName("errorLabel1")
        self.req.setStyleSheet("color: yellow")
        self.password2Input = QtWidgets.QLineEdit(self.page_2)
        self.password2Input.setGeometry(QtCore.QRect(160, 125, 251, 31))
        ...
        self.createButton.setGeometry(QtCore.QRect(210, 165, 121, 31))
        self.createButton.setObjectName("createButton")
        self.loginInput_2 = QtWidgets.QLineEdit(self.page_2)
        self.loginInput_2.setGeometry(QtCore.QRect(160, 24, 251, 31))
        self.loginInput_2.setObjectName("loginInput_2")
        self.password1Input = QtWidgets.QLineEdit(self.page_2)
        self.password1Input.setGeometry(QtCore.QRect(160, 75, 251, 31))
        ...
        self.login_2.setGeometry(QtCore.QRect(80, 25, 81, 31))
        self.login_2.setObjectName("login_2")
        self.password2 = QtWidgets.QLabel(self.page_2)
        self.password2.setGeometry(QtCore.QRect(30, 125, 131, 31))
        self.password2.setObjectName("password2")
        self.password1 = QtWidgets.QLabel(self.page_2)
        self.password1.setGeometry(QtCore.QRect(30, 75, 131, 31))
        self.password1.setObjectName("password1")
        self.backButton = QtWidgets.QPushButton(self.page_2)
        self.backButton.setGeometry(QtCore.QRect(380, 175, 91, 31))
        self.backButton.setObjectName("backButton")
        self.errorLabel2 = QtWidgets.QLabel(self.page_2)
        self.errorLabel2.setGeometry(QtCore.QRect(10, 175, 171, 21))
        self.errorLabel2.setText("")
        self.errorLabel2.setObjectName("errorLabel2")
        self.stackedWidget.addWidget(self.page_2)
        self.page_2.setTabOrder(self.loginInput_2, self.password1Input)
        self.page_2.setTabOrder(self.password1Input, self.password2Input)
        self.page_2.setTabOrder(self.password2Input, self.createButton)
        self.page_2.setTabOrder(self.createButton, self.backButton)
    ...
    def loginValidation(self):
        if re.match("^[a-z0-9A-Z]{5,16}$", self.loginInput.text()) is None or re.match("^[a-z0-9]{5,16}$",
            ...
            if self.checkIfUserLogged(self.loginInput.text()):
                ...
                self.errorLabel1.setStyleSheet("color: red")
                self.errorLabel1.setText("USER ALREADY LOGGED")
